...
const Courses = ({ params }: { params: { slug: string } }) => {
  ...
  console.log(params.slug, "asdfs098sd0", courseData)
        ...
        <div className="container">
          ...
          <div className="row grid">
            {courseData?.["data"]?.data
              ?.filter((result) => result.courseStatus === "Active" && result?.courseCategory === params?.slug)
              ?.map((result) => (
                <div
                ...
                >
                  <div className="gridarea__wraper">
                    <div className="gridarea__img">
                      <Link href={`/Courses/CourseDetails/${result?.id}`}>
                        {result?.uploadCourse && (
                          <video
                            // controls
