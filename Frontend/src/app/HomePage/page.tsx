          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              <div
                ...
                //
              >
                <Link className="best__categories__link" href="/Courses/Linux">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              <div
                ...
                //
              >
                <Link className="best__categories__link" href="/Courses/clound">
                  <div className="best__categories__info">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              <div
                ...
                //
              >
                <Link className="best__categories__link" href="/Courses/devops">
                  <div className="best__categories__info">
      ...
      <div className="aboutarea__3 testimonial__area__2 sp_bottom_90 sp_top_120">
        ...
        <div className="aboutarea__img__3">
          <img
            ...
            src="img/about/about_6.png"
            alt="about"
          />
          <img
            loading="lazy"
            className="aboutarea__3__img__2"
            src="img/about/about_7.png"
            alt="about"
          />
          <img
            loading="lazy"
            className="aboutarea__3__img__3"
            src="img/about/about_9.png"
            alt="about"
          />
        </div>
      </div>
              ...
              <div className="row">
                <div className="col-xl-3 col-lg-3">
                  <div className="copyright__logo">
                    <Link href="https://html.themewin.com/">
                      <img
                        loading="lazy"
