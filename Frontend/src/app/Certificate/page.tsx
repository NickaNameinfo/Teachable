    ...
    <div>
      ...
      <div
        ...
        style={{
          width: "65%",
          margin: "auto",
          backgroundImage: `radial-gradient(#ffffffcf, #ffffffcf), url('/img/Online-Learning.jpg')`,
          position: "relative",
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          <img src={"/img/logo/logo_1.png"} alt="logo" width={"35%"} />
        ...
        >
          ...
          >
            <img src={"/img/about/about_12.png"} alt="" width={"100%"} />
          </div>
          <div style={{ textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div style={{ textAlign: "center" }}>
            <img src={"/img/logo/logo_1.png"} alt="" style={{ width: "15%" }} />
